const CACHE='financebook-pro-web-v2.2.0';
const ASSETS=[
  './','./index.html','./styles.css?v=220','./manifest.webmanifest','./assets/financebook_icon.png',
  './js/app-v220.js?v=220','./js/data.js','./js/sync-v220.js?v=220','./js/firebase-config.js'
];
